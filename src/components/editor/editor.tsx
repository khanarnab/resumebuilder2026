...
export function Editor({ resume }: EditorProps) {
  ...
  return (
    <div className="flex h-[calc(100vh-4rem)] flex-col">
      ...
      <div className="flex items-center justify-between border-b border-gray-200 bg-white px-4 py-3 dark:border-gray-700 dark:bg-gray-900">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="rounded-md border border-gray-300 px-3 py-1.5 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-800 sm:hidden"
          >
            Sections
          </button>
          <button
      ...
      {/* Mobile Title */}
      <div className="border-b border-gray-200 bg-white px-4 py-2 dark:border-gray-700 dark:bg-gray-900 sm:hidden">
        <EditableTitle resumeId={resume.id} initialTitle={resume.title} />
      </div>
      ...
      <div className="flex flex-1 flex-col overflow-hidden sm:flex-row">
        ...
        <aside
          ...
          } w-full border-b border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800 sm:block sm:w-48 sm:border-b-0 sm:border-r`}
        >
          <nav className="flex flex-wrap gap-2 sm:flex-col sm:gap-1">
        ...
        {/* Preview Area - hidden on mobile unless toggled */}
        <div
          className={`${
            showPreview ? "block" : "hidden"
          } w-full border-t border-gray-200 bg-gray-100 p-4 dark:border-gray-700 dark:bg-gray-800 sm:block sm:w-80 sm:border-l sm:border-t-0`}
        >
