        ...
        return (
            <div className="flex items-center justify-between rounded-md border border-gray-200 p-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500">{experience.company || "No company"}</p>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input
                        ...
                        disabled={isCurrent}
                        className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-gray-900 focus:outline-none focus:ring-1 focus:ring-gray-900 disabled:bg-gray-100 disabled:text-gray-400"
                    />
                </div>
            </div>
